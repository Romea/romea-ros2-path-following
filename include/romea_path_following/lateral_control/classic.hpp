...
#ifndef ROMEA_PATH_FOLLOWING__LATERAL_CONTROL__CLASSIC_HPP_
#define ROMEA_PATH_FOLLOWING__LATERAL_CONTROL__CLASSIC_HPP_
...
class LateralControlClassic
  : public LateralControlBase<core::path_following::LateralControlClassic, CommandType>
{
public:
  using Base = LateralControlBase<core::path_following::LateralControlClassic, CommandType>;
