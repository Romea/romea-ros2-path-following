...
#ifndef ROMEA_PATH_FOLLOWING__SLIDING_OBSERVER__EXTENDED__CINEMATIC_LINEAR_TANGENT_HPP_
#define ROMEA_PATH_FOLLOWING__SLIDING_OBSERVER__EXTENDED__CINEMATIC_LINEAR_TANGENT_HPP_
...
class SlidingObserverExtendedCinematicLinearTangent
  : public core::path_following::SlidingObserverExtendedCinematicLinearTangent<CommandType>
{
public:
  using T = SlidingObserverExtendedCinematicLinearTangent<CommandType>;
  using Core = core::path_following::SlidingObserverExtendedCinematicLinearTangent<CommandType>;
